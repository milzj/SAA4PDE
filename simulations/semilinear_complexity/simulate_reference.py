...
def simulate_reference(n, N, beta_filename):
...
if __name__ == "__main__":
	...
	beta_filename = MPI.comm_world.bcast(beta_filename, root=0)

	n = MPI.comm_world.bcast(n, root=0)
	N = MPI.comm_world.bcast(N, root=0)

	sol = simulate_reference(n, N, beta_filename)
