"""Compute solution to nominal problem."""
...
import os
outdir = "output/"
outdir = outdir+"Nominal_Simulation_n="+str(n)
...
filename = outdir + "/" +  "nominal_solution_n={}".format(n)
...
sol.pop("control")
sol.pop("precond")
filename = "nominal_solution_n={}_exit_data".format(n)
